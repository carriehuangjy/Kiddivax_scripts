...
dir <- "Kiddivax_scripts/KiddivaxMain_JID_titerprot_scripts/data/KiddivaxMainV2/"
source("Kiddivax_scripts/KiddivaxMain_JID_titerprot_scripts/code/source_1.r")
source("Kiddivax_scripts/KiddivaxMain_JID_titerprot_scripts/code/source_2.r")
source("Kiddivax_scripts/KiddivaxMain_JID_titerprot_scripts/code/source_3.r")
...
fluproxy <- read.csv("Kiddivax_scripts/KiddivaxMain_JID_titerprot_scripts/data/influenza_proxy_1998to2013.csv")
